...
export default function ProgressLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-background via-background/90 to-background">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,hsl(var(--primary)/0.12),transparent_25%),radial-gradient(circle_at_80%_0%,hsl(var(--secondary)/0.12),transparent_25%),radial-gradient(circle_at_50%_80%,hsl(var(--accent)/0.08),transparent_25%)]" />
